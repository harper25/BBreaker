...
while not done:
    ...
    # print(plus)
    c1 = pygame.draw.circle(screen, GREEN, plus.center, 70, 5)
    pygame.draw.rect(screen, BLACK, c1, 2)
    pygame.draw.rect(screen, BLUE, plus, 2)

    font_obj = pygame.font.Font('freesansbold.ttf', 32)
    text_surface_obj = font_obj.render('Hello World!', True, GREEN, BLUE)
    text_rect_obj = text_surface_obj.get_rect()
    text_rect_obj.center = (280, 150)
    screen.blit(text_surface_obj, text_rect_obj)

    font_obj = pygame.font.Font('freesansbold.ttf', 40)
    text_surface_obj = font_obj.render(' + ', True, GREEN, BLUE)
    text_rect_obj = text_surface_obj.get_rect()
    text_rect_obj.center = (60, 100)
    screen.blit(text_surface_obj, text_rect_obj)

    c2 = pygame.draw.circle(screen, RED, text_rect_obj.center, 40, 5)
    pygame.draw.rect(screen, BLACK, c2, 2)
